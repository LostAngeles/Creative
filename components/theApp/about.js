...
function aboutApp() {
	...
	isAbout = !isAbout;
	if (isAbout) {
		document.body.style.backgroundImage = 'url(components/intro/nature-blur.jpg)';		
	...
	if (!isAbout) {
		document.body.style.backgroundImage = 'url(components/intro/nature-animal-fog-freedom-52500.jpg)';
